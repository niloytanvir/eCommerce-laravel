    ...
    public function run()
    {
      DB::table('products')->insert([
        [
            'name'=>'Oppo mobile',
            "price"=>"300",
            "description"=>"smartphone with 8gb ram 256 gb storage",
            "category"=>"mobile",
        ...
        [
            'name'=>'Panasonic Tv',
            "price"=>"400",
            "description"=>"A 21 inch smart tv",
            "category"=>"tv",
        ...
        [
            'name'=>'Soni Tv',
            "price"=>"500",
            "description"=>"A 32 inch smart tv with much more feature",
            "category"=>"tv",
        ...
        [
            'name'=>'LG fridge',
            "price"=>"200",
            "description"=>"A 200 litre fridge ",
            "category"=>"fridge",
